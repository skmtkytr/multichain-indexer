  ...
  class ProcessBlockActivity < Temporalio::Activity::Definition
    ...
    def process_full(params)
      ...
      ActiveRecord::Base.transaction do
        ...
        IndexedTransaction.upsert_all(tx_records, unique_by: [:chain_id, :tx_hash]) if tx_records.any?
        IndexedLog.upsert_all(log_records, unique_by: [:chain_id, :block_number, :log_index]) if log_records.any?
      end
